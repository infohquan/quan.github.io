<%@ Page Language="C#" MasterPageFile="~/WebAdmin/MasterPage.master" AutoEventWireup="true" CodeFile="VideoClip_Old.aspx.cs" Inherits="WebAdmin_Others_VideoClip_Old" %>
...
<div id="center-column">
	<div class="top-bar">
		<h1><b><span id="lblTitle1" runat="server">Thêm Video Clip sản phẩm</span></b></h1>
	</div><br />
    <div class="table">
		...
		<table class="listing form" cellpadding="0" cellspacing="0">
			<tr>
				<th class="full" colspan="2"><span id="lblTitle2" runat="server">Thêm Video Clip sản phẩm</span></th>
			</tr>
            <tr class="bg">
            ...
            <tr>
                ...
                <td class="last"><asp:TextBox ID="txtVideoName" runat="server" Width="343px"></asp:TextBox></td>
            </tr>
            <tr class="bg">
                <td class="first">
                    <strong>Chọn hình ảnh đại diện</strong></td>
                <td class="last">
                    <%if (Globals.GetStringFromQueryString("Action") == "Edit") {%>
                    <img id="ImgVideo" alt="" src="" runat="server" />
                    <%} %>
                    <FUA:FileUploaderAJAX ID="FileUploadImage" runat="server" />
                </td>
            </tr>
			<tr>
				<td class="first"><strong>Chọn file Video</strong></td>
				<td class="last">
                    ...
                    &nbsp;<span id="lblTemp" style="font-size:13px; font-weight:bold; color:Red;" runat="server">(Vui lòng chỉ chọn file .flv hoặc .wmv)</span>
				</td>
			</tr>
			<tr class="bg">
				<td class="first"></td>
  ...
  <div class="clearthis"></div>
    <div class="top-bar">
		<h1><b>Danh sách Video Clip sản phẩm</b></h1>
    </div>
    <div class="clearthis"></div>
    ...
    <div id="VideoClipList">
        <asp:GridView ID="gridViewVideo" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="T&#234;n video" Visible="False">
                    <ItemTemplate>

...
public partial class WebAdmin_Others_VideoClip : System.Web.UI.Page
{
    ...
    private void LoadDataEdit()
    {
        //try
        {
            ...
            txtVideoEmbedCode.Value = Convert.ToString(ds.Tables[0].Rows[0]["VideoSrc"]);
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        //try
        {
            ...
            string VideoEmbedCode = txtVideoEmbedCode.Value.Trim();
            int kq = -1;
            if (Action == "Edit")
            {
                int VideoID = Globals.GetIntFromQueryString("VideoID");
                kq = obj.UpdateVideoClip(VideoID, Globals.AgentCatID, ddlLanguage.SelectedValue, ProductID, "", VideoEmbedCode, VideoName, "");
                ShowMessage(kq, "cập nhật");
            }
            else
            {
                kq = obj.InsertVideoClip(Globals.AgentCatID, ddlLanguage.SelectedValue, ProductID, "", VideoEmbedCode, VideoName, "");
                ShowMessage(kq, "thêm");
            }

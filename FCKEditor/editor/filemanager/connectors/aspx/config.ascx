...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        //UserFilesPath = "http://localhost:2847/vpland/Cache/Uploads/ImageFiles/UserUploads/";
		...
		//TypeConfig[ "Image" ].FilesPath					= "%UserFilesPath%image/";  //Sẽ có folder image ở trong thư mục của mình
        TypeConfig["Image"].FilesPath = "%UserFilesPath%";        //Sửa lại, bỏ image đi

...
namespace Connection
{
    ...
    { 
        ...
        //public string m_Con = "server=SERVER;uid=sa;pwd=123456;database=agoodweb";
        public string m_Con = "server=67.228.227.18;uid=cdguser;pwd=cdgroup;database=cdg_data";
        public MyConnection()
        { }
